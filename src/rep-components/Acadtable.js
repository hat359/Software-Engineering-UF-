...
<td align="center" className="tablecon" style={{marginLeft:'50px'}}>{props.courses}</td>
<td align="center"  className="tablecon">{<ChatModal cid={props.cid} course={props.courses}/>}</td>
